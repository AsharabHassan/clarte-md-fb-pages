    ...
    <section className="funnel-scan">
      ...
      <ol className="funnel-steps" aria-label="How it works">
        ...
        <li className="funnel-step">
          ...
          <span className="funnel-step__label">Get your free AI skin report</span>
        </li>
        <li className="funnel-step">
          <span className="funnel-step__num">3</span>
          <span className="funnel-step__label">Order your recommended protocol</span>
        </li>
      </ol>
